        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">
              Join the AI revolution today. See how AxionX.AI can transform your lead generation.
            </p>
          </div>
              ...
              >
                ...
                <div className="mt-12 p-6 bg-dark-bg rounded-xl border border-neon-green/10">
                  <p className="text-gray-400 italic">
                    "AxionX.AI helped us achieve in one month what would normally take a year. The ROI is incredible!"
                  </p>
